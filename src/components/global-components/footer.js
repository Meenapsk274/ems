          ...
          <div className="row footer-address-bar">
            <div className="container">
              <div className="row mt-25">
                <div className=" col-xl-5 col-lg-5 mobile-location">
                  <h4 className="sub_text mt-1">Subscribe to Our Newsletter</h4>
                </div>
               
                <div className="col-xl-7 col-lg-7 col-md-12 mob-newsletter subscribe-div">
                <div className="row">
                  <Form
                    name="normal_login"
                  ...
                  >
                    <div className="input-group mb-3">
                      ...
                      <div className="col-lg-10 col-md-10 col-sm-6 col-8 pt-0 pl-0">
                      ...
                      <div className="col-lg-2 col-md-2 col-sm-6 col-4 subscribe-btn">
                      <Form.Item>
                        <Button
                          type="danger"
                          htmlType="submit"
